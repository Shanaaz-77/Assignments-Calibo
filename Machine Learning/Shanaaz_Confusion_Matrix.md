...
Top-right box (10) = __FALSE POSITIVE__ (We said cat, but it was dog )
Bottom-left box (10) = __FALSE NEGATIVE__  (We said dog, but it was cat )
Bottom-right box (50) = __TRUE NEGATIVE__ (We said dog , it was dog )
...
Precision = TP ÷ (TP + FP) = __80__ ÷ (__80__ + __20__) = __80__%

Recall = TP ÷ (TP + FN) = __80__ ÷ (__80__ + __20__) = __80__%
...
```
              ...
              ---------------------------
Said          |    25       |     5      |
SPAM          |  TP(CORRECT)|  FP(Opps)  |
              ---------------------------
Said          |    5      |      65     |
GOOD          |  FN(Opps) |  TN(Correct)|
              ---------------------------
```
...
If good mails are went to spam then we miss important mails (such as exams, jobs, and more), so missing some spam is less harmful tha missing an important mail.
...
**Answer:** Missing cancer is MUCH worse! We need high __Recall__ (Precision / Recall)
...
**Answer:** Recommending bad videos annoys users! We need high __Precsion__ (Precision / Recall)
...
**Answer:** Can't miss weapons! We need high __Recall__ (Precision / Recall)
...
**Your answer:** We need high __Recall__ (Precision / Recall)

**Why?** __Can't miss deserving student, We need high Recall__
...
**Model A:**
- Precision = 90 ÷ (90 + 50) = 90 ÷ 140 = __64.2__%
- Recall = 90 ÷ (90 + 10) = 90 ÷ 100 = __90__%

**Model B:**
- Precision = 70 ÷ (___70__ + __10__) = __87.5__%
- Recall = 70 ÷ (__70__ + __30__) = ___70__%
...
1. **Defective products reaching customers costs $1000 each**
   ...
   - Why? __Because Model A misses less defective products__
     
2. **Throwing away good products costs $100 each**
   - Choose: Model A / ✅Model B
   - Why? __Because model B throws away fewer good products__
